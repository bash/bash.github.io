...
My favourite model of computation so far is [Lambda Calculus]. A [functional programming enthusiast], I may be a bit biased though…
...
We could easily build more complicated structures (trees, linked lists, etc.) from the functions discussed in this post. I might write a follow-up post soon :)
